...
$sql = "SELECT * FROM data WHERE section = 'news'";
        ...
        <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">ADD News</h5>
                            </div>
                            <table class="table">
                                  <thead>
                                    <tr>
                                  ...
                                  <?php
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $get['jobTitle']; ?></td>
                                      <td><?php echo $get['description']; ?></td>

                                      <?php if ($get['image'] != ''){ ?>
	                                  	<td>
	                                    <a class="btn default btn-outline image-popup-vertical-fit el-link" href="image/<?php echo $get['image']; ?>">
	                                    	View Image
	                                    </a>
	                                </td>
	                                  <?php }else{  ?>
									  ...
									  <?php if ($get['video'] != ''){ ?>
									    <td>
									    	<a class="btn default btn-outline image-popup-vertical-fit el-link" href="video/<?php echo $get['video']; ?>">
	                                    	View Video
	                                    	</a>
									    
									    </td>
									<?php }else{  ?>
										<td>No videos Here</td>
									<?php } ?>
                                    <?php if ($get['attached'] != ''){ ?>
									<td>
										<a href="attached/<?php echo $get['attached']; ?>">
											<?php echo $get['attached']; ?>
									 	</a>
									 </td>	   
									<?php }else{  ?>
										<td>No attached files Here</td>

									<?php } ?>
									<td>
										<a href="edit.php?id=<?php echo $get['id']; ?>" data-toggle="tooltip" data-placement="top" title="Update">
                                            <i class="mdi mdi-check"></i>
                                        </a>
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="Delete" onclick="myFunction('delete.php?id=<?php echo $get['id']; ?>')">
