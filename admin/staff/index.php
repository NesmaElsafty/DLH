...
$name = $_SESSION['name'];
$sql = "SELECT * FROM data WHERE section = 'staff'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-6">
                         <div class="card">
                            ...
                            <?php
									while ($more = mysqli_fetch_assoc($result)) { 
										if ($num == 0) { ?> 
											<h1>No Staff Yet</h1>
									<?php
										}else{
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="image/<?php echo $more['image']; ?>" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                        <h6 class="font-medium"><?php echo $more['username']; ?></h6>
                                        <span class="m-b-15 d-block">
                                        	Email: <?php echo $more['email']; ?>
                                        </span>
                                        <span class="m-b-15 d-block">
                                        	JobTitle: <?php echo $more['jobTitle']; ?>
                                        </span>
                                        <span class="m-b-15 d-block">
                                        	Subject: <?php echo $more['subject']; ?>
                                        </span>
                                        <div class="comment-footer">
                                            <!-- <span class="text-muted float-right"><?php echo $more['subject'] . ' ' . $more['jobTitle']; ?></span>  -->
                                            <a href="edit.php?id=<?php echo $more['id']; ?>">
                                            	<button type="button" class="btn btn-cyan btn-sm">Edit</button>
                                            </a>
                                            <!-- <button type="button" class="btn btn-success btn-sm">Publish</button> -->
                                            <button type="button" class="btn btn-danger btn-sm" onclick="myFunction('delete.php?id=<?php echo $more['id']; ?>')">
                                            	Delete
                                        	</button>
                                        </div>
                                    </div>
