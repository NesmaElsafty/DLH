...
$sql = "SELECT * FROM data WHERE section = 'Activities' GROUP BY jobTitle";
$result = mysqli_query($connect,$sql);
// $get = mysqli_fetch_all($result,MYSQLI_ASSOC);
        ...
        <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">Activities</h5>
                            </div>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
									...
									?>		
                                    <tr>
                                        <td><?php echo $more['jobTitle']; ?></td>
                                        <td>
                                            <a href="show.php?title=<?php echo $more['jobTitle']; ?>" data-toggle="tooltip" data-placement="top" title="View">
                                                <i class="mdi mdi-check"></i>
                                            </a>
                                         	<!-- BUG Here -->
                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Delete"
                                      	onclick="myFunction('delete.php?title=<?php echo $more['jobTitle']; ?>')">
