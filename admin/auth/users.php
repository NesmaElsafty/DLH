...
if (isset($_SESSION)){
	if ($_SESSION['auth'] == 'master' || $_SESSION['auth'] == 'admin' ) {
		$sql = "SELECT * FROM users WHERE auth = 'admin' OR auth = 'user'";
        ...
        <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php   if ($_SESSION['auth'] == 'master') {
									while ($more = mysqli_fetch_assoc($get)) { 
										if($more['auth'] == 'admin' || $more['auth'] == 'user'){ ?>
                            <div class="comment-widgets scrollable">
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                        <h6 class="font-medium"><?php echo $more['name']; ?> </h6>
                                        <span class="m-b-15 d-block"><?php echo $more['email']; ?></span>
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"><?php echo $more['auth']; ?></span> 
                                            <button type="button" class="btn btn-danger btn-sm" onclick="myFunction('delete.php?id=<?php echo $more['id']; ?>')">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
			                                ...
			                                <div class="d-flex flex-row comment-row m-t-0">
			                                    ...
			                                    <div class="comment-text w-100">
			                                        ...
			                                        <div class="comment-footer">
			                                            ...
			                                            <button onclick="myFunction('delete.php?id=<?php echo $more['id']; ?>')" type="button" class="btn btn-danger btn-sm">Delete</button>
			                                        </div>
			                                    </div>
			                                </div>
			                            </div>
