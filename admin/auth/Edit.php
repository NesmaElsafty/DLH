...
if (isset($_SESSION['auth'])) {
		...
		$sql = "SELECT * FROM users WHERE name = '".$_GET['name']."' AND auth = '".$_SESSION['auth']."'";
                            ...
                            <form class="form-horizontal" action="update.php" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="newname" class="form-control" id="fname" value="<?php echo $row['name'];?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" name="newemail" class="form-control" id="lname" value="<?php echo $row['email']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Password</label>
                                        <div class="col-sm-9">
                                            <input type="password" class="form-control" id="lname" name='newpassword' value="<?php echo $row['password'];?>" required>
                                        </div>
                                    </div>
                                </div>
