...
// echo $_SESSION['auth'] . " " . $_SESSION['name'];

if (isset($_SESSION)){

if ($_SESSION['auth'] == 'master' || $_SESSION['auth'] == 'admin' ) {
		
?>

<?php 
	$query = "SELECT * FROM users WHERE auth = 'admin'";
	$result = mysqli_query($connect,$query);
	$rows = mysqli_num_rows($result);

	$sql_q = "SELECT email FROM users";
	$get = mysqli_query($connect,$sql_q);
...
if (isset($_POST['add'])) {
	...
	// Search in Array >> Email repeating validation
	$count = 0;
		while ($more = mysqli_fetch_assoc($get)) {
			if ($more['email'] == $email) {
				$count++;
			}
		}
		...
		if ($count == 0) {
			$sql = "INSERT INTO users (name ,email ,password ,auth) VALUES ('".$username."','".$email."','".$password."','".$auth."')";
			// die($sql);
			...
			if ($add) {
				...
				// echo "can't add value";
			}
		}else{
			// echo 'This Email is Existed before';			
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="profile.php?name=<?php echo $_SESSION['name']; ?>"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                                
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-email m-r-5 m-l-5"></i> Inbox</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="edit.php?name=<?php echo $_SESSION['name']; ?>"><i class="ti-settings m-r-5 m-l-5"></i> Account Setting</a>
                                <div class="dropdown-divider"></div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="users.php" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">Users </span></a>
                        </li>
                    <?php } ?>
                            ...
                            <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="form-control" id="fname" placeholder="User Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" name="email" class="form-control" id="lname" placeholder="Email Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="btn-group">
                                        <select type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name="auth">Select Auth
