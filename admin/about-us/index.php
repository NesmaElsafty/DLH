...
$control = '';
$name = $_SESSION['name'];
$sql = "SELECT * FROM data WHERE section = 'about-us'";
$result = mysqli_query($connect,$sql);
// $get_all = mysqli_fetch_all($get,MYSQLI_ASSOC);
$get_num = mysqli_num_rows($result);
...
if ($get_num > 0) {
	...
	echo 'please Check DataBase Again';
}
?>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
						...
						<!-- <?php 	if ($get_num > 0) { ?>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="edit.php?id=<?php echo $get['id']; ?>">Edit</a>

						<?php	}else{ ?>
								<div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="create.php">Create Data</a>
						<?php	} ?> -->
                            </div>
                        </li>
                        <li class="nav-item button">
                            <a class="nav-link dropdown-toggle" href="<?php echo $link; ?>" id="navbarDropdown" role="button"  aria-haspopup="true" >
                             <span class="d-none d-md-block"><?php echo $control; ?> <!-- <i class="fa fa-angle-down"></i> --></span>
                             <span class="d-block d-md-none"><i class="fa fa-plus"></i></span>   
                            </a>
                        </li> 
                        <li class="nav-item button">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"  aria-haspopup="true" onclick="myFunction('delete.php?id=<?php echo $get['id']; ?>')">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="index.php" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">About Us</span></a></li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="image/<?php echo $get['image']; ?>" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="image/<?php echo $get['image']; ?>"><i class="mdi mdi-magnify-plus"></i></a></li>
                                            <!-- <li class="el-item"><a class="btn default btn-outline el-link" href="<?php echo $get['image']; ?>" download><i class="mdi mdi-link"></i></a></li> -->
                                        </ul>
                                    </div>
                                </div>
