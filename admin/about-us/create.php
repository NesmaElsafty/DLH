                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="store.php" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <h4 class="card-title">Our Data</h4>
                                    <input type="hidden" name="section" value="about-us">
                                    <!-- Email -->
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-left control-label col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" name="email" class="form-control" id="email1" placeholder="Email Here" required>
                                        </div>
                                    </div>
                                    <!-- ADDRESS -->
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-left control-label col-form-label">Address</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="address" class="form-control" id="lname" placeholder="Address Here" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="phone" class="form-control" id="cono1" placeholder="Contact No Here" required>
                                        </div>
                                    </div>
                                    <!-- description -->
                                    <div class="form-group row">
                                    ...
                                    <!-- Mission --> 
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-left control-label col-form-label">Mission</label>
                                        <div class="col-sm-9">
                                    ...
                                    <!-- Vision -->
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-left control-label col-form-label">Vision</label>
                                        <div class="col-sm-9">
