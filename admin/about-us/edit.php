                            ...
                            <form class="form-horizontal" action="update.php" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" name="email" class="form-control" id="email1" value="<?php echo $row['email']; ?>"  required>
                                        </div>
                                    </div>
                                    <!-- ADDRESS -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="address" class="form-control" id="lname" value="<?php echo $row['address']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="phone" class="form-control" id="cono1" value="<?php echo $row['phone']; ?>" required>
                                        </div>
                                    </div>
                                    <!-- description -->
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="mission" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="vision" required>
                                            	<?php echo $row['vision']; ?>
                                            </textarea>
                                        </div>
                                    </div>
